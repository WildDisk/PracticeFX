...
import ru.wilddisk.practicefx.Employee
import java.net.URL
import java.util.*
...
class ChartController : Initializable {
    ...
    override fun initialize(p0: URL?, p1: ResourceBundle?) {
        empNoCol.cellValueFactory = TreeItemPropertyValueFactory<Employee, String>("empNo")
        firstNameCol.cellValueFactory = TreeItemPropertyValueFactory<Employee, String>("firstName")
        lastNameCol.cellValueFactory = TreeItemPropertyValueFactory<Employee, String>("lastName")
        positionCol.cellValueFactory = TreeItemPropertyValueFactory<Employee, String>("position")
        genderCol.cellValueFactory  = TreeItemPropertyValueFactory<Employee, String>("gender")
        singleCol.cellValueFactory = TreeItemPropertyValueFactory<Employee, Boolean>("single")
